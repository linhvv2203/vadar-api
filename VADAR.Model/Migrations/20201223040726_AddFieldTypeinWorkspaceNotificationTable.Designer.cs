...
namespace VADAR.Model.Migrations
{
    ...
    [Migration("20201223040726_AddFieldTypeinWorkspaceNotificationTable")]
    partial class AddFieldTypeinWorkspaceNotificationTable
    {
        /// <inheritdoc/>
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VADAR.Model.Models.NotificationSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VADAR.Model.Models.NotificationSettingCondition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("NotificationSettingConditions");
                });
            ...
            modelBuilder.Entity("VADAR.Model.Models.Workspace", b =>
                {
                    ...
                    b.Property<bool>("IsCreatedOrganisation")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("VADAR.Model.Models.NotificationSettingCondition", b =>
                {
                    b.HasOne("VADAR.Model.Models.NotificationSetting", "NotificationSetting")
                        .WithMany("NotificationSettingConditions")
